...
<html>
	...
	<body>
		<div id="modules">
			<a href="auftragsMgmt/index.php"><img src="img/logo_auftragsMgmt.png" alt="FOSY - Auftragsmanagement"></a><br/>
			<a href="crm/index.php"><img src="img/logo_CRM.png" alt="FOSY - Kundenmanagement"></a><br/>
			<a href="reporting/index.php?content=dashboard"><img src="img/logo_reporting.png" alt="FOSY - Reporting"></a><br/>
		</div>
